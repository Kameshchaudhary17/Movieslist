import { Home, Library, Users, MessageCircle, TrendingUp } from 'lucide-react';
  ...
  return (
    <aside className="w-64 p-6 space-y-2">
      ...
      >
        ...
        <span className="ml-auto bg-purple-600 text-white text-xs rounded-full px-2 py-1">3</span>
      </button>
      <button
